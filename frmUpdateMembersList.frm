...
Begin VB.Form frmUpdateMembersList 
   Caption         =   "Form1"
   ClientHeight    =   5955
   ClientLeft      =   120
   ClientTop       =   450
   ...
   Begin VB.CommandButton cmdUpdate 
      ...
      Width           =   1335
   End
   Begin MSAdodcLib.Adodc dtaMembers 
      Height          =   375
      Left            =   360
      Top             =   5280
      Visible         =   0   'False
   ...
   Begin MSDataGridLib.DataGrid DataGrid1 
      Bindings        =   "frmUpdateMembersList.frx":0000
      Height          =   3135
      Left            =   480
      TabIndex        =   0
      Top             =   1920
      ...
      BeginProperty Column11 
         DataField       =   "DATE OF COMMISSIONING"
   ...
   Begin VB.Image Image1 
      Height          =   1335
      Left            =   120
      Picture         =   "frmUpdateMembersList.frx":0019
      Stretch         =   -1  'True
      Top             =   120
      Width           =   1455
   End
   ...
   End
End
Attribute VB_Name = "frmUpdateMembersList"
Attribute VB_GlobalNameSpace = False
Attribute VB_Creatable = False
Attribute VB_PredeclaredId = True
Attribute VB_Exposed = False
Private Sub cmdUpdate_Click()
dtaMembers.Recordset.Update
MsgBox "Member Details successfully saved"
End Sub
